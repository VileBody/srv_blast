...
class RedisChatStateStore:
    ...
    async def reset_to_wait_audio(self, chat_id: int) -> ChatState:
        ...
        existing.hook_category = ""
        existing.hook_device = ""
        existing.hook_drop_t = None
        existing.effect_hook = ""
        existing.effect_transition = ""
        existing.effect_extra = ""
        existing.effect_extra_full = False
        existing.effect_hook_extend = ""
        existing.visual_transition = ""
        existing.visual_style = ""
        existing.visuals_done = False
