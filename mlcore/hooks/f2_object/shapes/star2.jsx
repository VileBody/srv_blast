/*** rebuild_shape_star2.jsx — пара "star2" + "star2layer" с эффектами minimax flash + snap wipe.
 ...
 *   3. star2layer    (увеличенная копия фигуры)   — появляется через 0.267с
 *   4. star2    (базовая фигура)             — стартует на t0
...
var SHAPE = {
  ...
  starPoints: 5, starInner: 103.8, starOuter: 201.7,
  ellipseSize: null, rectSize: null,
  fill: [1, 0.93725502163756, 0.93725502163756, 1],
  strokeWidth: 20,                       // null => без обводки
  vectorPos: [-194.666666666667, -268.436453925239],
  vectorScaleBase: null,                 // null => не задаём (по умолч. 100)
  vectorScaleLayer: [200, 200],
  layerPosDefault: [734.666666666667, 1247.69708930122, 0]
};
// ──────────────────────────────────────────────────────────────────────────────────────────────
