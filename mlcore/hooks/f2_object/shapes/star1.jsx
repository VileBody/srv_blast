/*** rebuild_shape_star1.jsx — пара "star1" + "star1layer" с эффектами minimax flash + snap wipe.
 ...
 *   3. star1layer    (увеличенная копия фигуры)   — появляется через 0.267с
 *   4. star1    (базовая фигура)             — стартует на t0
...
var SHAPE = {
  name: "star1",
  pathType: "star",                      // "star" | "polygon" | "ellipse" | "rect"
  starPoints: 10, starInner: 138.6, starOuter: 236.2,
  ellipseSize: null, rectSize: null,
  fill: [1, 0.93725502163756, 0.93725502163756, 1],
  strokeWidth: 20,                       // null => без обводки
  vectorPos: [-74.2222222222222, -152.888888888889],
  vectorScaleBase: null,                 // null => не задаём (по умолч. 100)
  vectorScaleLayer: [205, 205],
  layerPosDefault: [614.222222222222, 1139.54756503635, 0]
};
// ──────────────────────────────────────────────────────────────────────────────────────────────
