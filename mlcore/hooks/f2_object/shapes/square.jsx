/*** rebuild_shape_square.jsx — пара "square" + "squarelayer" с эффектами minimax flash + snap wipe.
 ...
 *   3. squarelayer    (увеличенная копия фигуры)   — появляется через 0.267с
 *   4. square   (базовая фигура)             — стартует на t0
...
var SHAPE = {
  name: "square",
  pathType: "rect",                      // "star" | "polygon" | "ellipse" | "rect"
  starPoints: null, starInner: null, starOuter: null,
  ellipseSize: null, rectSize: [348.444444444444, 348.444444444444],
  fill: [1, 1, 1, 1],
  strokeWidth: null,                     // без обводки
  vectorPos: [-83.5555555555553, -149.030422634549],
  vectorScaleBase: null,                 // null => не задаём (по умолч. 100)
  vectorScaleLayer: [200, 200],
  layerPosDefault: [623.555555555555, 1109.03042263455, 0]
};
// ──────────────────────────────────────────────────────────────────────────────────────────────
