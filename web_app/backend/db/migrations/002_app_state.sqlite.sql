-- Состояние приложения (SQLite-вариант). Postgres-близнец: 002_app_state.postgres.sql.
--
-- Хранение документами (JSON в TEXT): приложение мутирует словари на месте, и документ
