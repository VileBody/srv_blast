...
HOOK_INTROS: dict[str, HookIntro] = {
    "sound": {
        "text": (
            "🔥 *Прогрев* — первые секунды ролика отдаём тебе.\n"
            "*Звук*: свой разгон, риз или голос поверх футажа.\n"
            "*Видео*: своя вырезка (кусок интервью, мем) во весь кадр со своим "
            "звуком — трек на это время уходит на фон.\n"
