...
AE_COMPOSITION_STAGE = (
    ...
    '      ВАЖНО: время в keyframes ВСЕГДА АБСОЛЮТНОЕ в таймлайне композиции (секунды), не относительное.\n'
    '      Для любого keyframe должно выполняться: inPoint <= time <= outPoint.\n'
    '      Если animId="anim_reveal_opacity" — overrides.selector_start ОБЯЗАТЕЛЕН.\n'
    '      Допустимые формы overrides.selector_start (везде ABS time):\n'
    '        A) Raw keys: {"keys":[{"time":10.71,"value":0,"templateRef":"tpl_ease_explosive"},{"time":12.22,"value":100,"templateRef":"tpl_ease_explosive"}]}\n'
    '        B) Procedural: {"procedural":{"kind":"selector_ramp_abs","t_start":10.71,"t_end":12.22,"from":0,"to":100,"tpl_start":"tpl_ease_explosive","tpl_end":"tpl_opacity_fade_end_fast"}}\n'
    '        C) Procedural steps: {"procedural":{"kind":"selector_steps_3_abs","t0":15.47,"t1":15.80,"t2":16.43,"v0":25,"v1":50,"v2":100,"tpl0":"tpl_linear_hold","tpl1":"tpl_linear_hold","tpl2":"tpl_ease_explosive"}}\n'
    '      Никаких относительных dt/keys_rel — только абсолютные секунды.\n'
    '      templateRef/tpl_* — только "tpl_*" из text_motion_library.json.\n'
    '      Для transform opacity (tf_subtitle_base.opacity) можно делать fade-out так:\n'
    '        overrides.opacity = {"procedural":{"kind":"opacity_fade_abs","t_start":12.76,"t_end":13.59,"from":100,"to":0,"tpl_start":"tpl_fade_out","tpl_end":"tpl_fade_in_stop"}}\n'
