...
PLAN_VISUALS_SYSTEM = (
    ...
    "Important: смена картинки должна происходить в ритм музыки. Нам можеь потребоваться наложить эффект на дроп, или что-то еще. Делай с учетом этого"
)

SUBTITLES_SYSTEM = (
    "Ты субтитровщик. Тебе дают вертикальное видео с музыкой/вокалом.\n"
    "Сделай субтитры в формате SRT (индекс, временной интервал, текст).\n"
