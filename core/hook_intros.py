...
HOOK_INTROS: dict[str, HookIntro] = {
    "sound": {
        "text": (
            "🔥 *Прогрев* — твоя вставка перед выбранным дропом.\n"
            "*Звук*: разгон, риз или голос поверх футажа; на дропе — молния.\n"
            "*Видео*: интервью, мем или другая вырезка во весь кадр со своим "
            "звуком. Основной трек играет фоном на 10% и мягко выходит на 100% "
            "за последнюю секунду перед дропом. На дропе начинается основной "
            "монтаж без молнии."
        ),
        "video": "",
    },
