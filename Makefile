...
WINDOWS_API_MODE ?= $(WINDOWS_RENDER_API_MODE)
...
> @echo "  make dispatch [WINDOWS=...] [WINDOWS_API_MODE=render|jobs]  # send built artifacts to Windows node"
