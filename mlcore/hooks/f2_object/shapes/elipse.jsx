/*** rebuild_shape_elipse.jsx — пара "elipse" + "elipselayer" с эффектами minimax flash + snap wipe.
 ...
 *   3. elipselayer    (увеличенная копия фигуры)   — появляется через 0.267с
 *   4. elipse   (базовая фигура)             — стартует на t0
...
var SHAPE = {
  name: "elipse",
  pathType: "ellipse",                   // "star" | "polygon" | "ellipse" | "rect"
  starPoints: null, starInner: null, starOuter: null,
  ellipseSize: [490.666666666667, 490.666666666667], rectSize: null,
  fill: [1, 1, 1, 1],
  strokeWidth: null,                     // без обводки
  vectorPos: [-101.777777777778, -195.252644856771],
  vectorScaleBase: [75, 75],
  vectorScaleLayer: [150, 150],
  layerPosDefault: [641.777777777778, 1155.25264485677, 0]
};
// ──────────────────────────────────────────────────────────────────────────────────────────────
