...
function build(comp){
  ...
  var ch=fx.addProperty("ADBE Simple Choker"); setP(ch,"ADBE Simple Choker-0002",si(0.4));
  var ww=fx.addProperty("ADBE Wave Warp"); setP(ww,"ADBE Wave Warp-0001",si(8)); setP(ww,"ADBE Wave Warp-0002",si(6)); setP(ww,"ADBE Wave Warp-0003",1200); setP(ww,"ADBE Wave Warp-0004",0);
